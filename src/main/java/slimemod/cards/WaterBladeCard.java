...
public class WaterBladeCard extends BaseCard {
    private final static CardInfo cardInfo = new CardInfo(
            "WaterBladeCard", // Card ID. Will be prefixed with mod id, so the final ID will be "modID:MyCard"
